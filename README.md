...
| `lakes.json` | NHDPlus HR waterbodies; Census cartographic state outlines (1:500,000) | For the Santa Fe and Rainbow maps, over the springs belt and the St. Johns (`LAKES_AREAS`). Lakes ≥ 0.2 km² and wetlands ≥ 1.5 km², simplified; wetland islands and scraps under 0.5 km² are dropped. The sea is everything in a box around both river mouths that isn't land in the Census's shoreline-clipped state outlines. Along the Indian River Lagoon, which those outlines count as land, NHD's bays join it, and so do the wide rivers that open onto them, like the St. Lucie's estuary. |
